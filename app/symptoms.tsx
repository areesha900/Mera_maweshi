    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.body} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.animalRow}>
          {ANIMALS.map(a => (
            ...
            >
              ...
              <UrduText isUrdu={isUrdu} style={[styles.animalLabel, selectedAnimal === a.key && styles.animalLabelSelected]}>
                {isUrdu ? a.ur : a.en}
              </UrduText>
            </TouchableOpacity>
          ))}
        ...
        <View style={styles.selectorGroup}>
          <UrduText isUrdu={isUrdu} style={[styles.selectorLabel, isUrdu && styles.rtl]}>{t.sexLabel}</UrduText>
          <View style={styles.selectorRow}>
            {SEX_OPTIONS.map(s => (
              ...
              >
                ...
                <UrduText isUrdu={isUrdu} numberOfLines={0} style={[styles.selectorBtnText, selectedSex === s.key && styles.selectorBtnTextSelected]}>
                  {isUrdu ? s.ur : s.en}
                </UrduText>
              </TouchableOpacity>
            ))}
        ...
        {/* Age selector */}
        <View style={styles.selectorGroup}>
          <UrduText isUrdu={isUrdu} style={[styles.selectorLabel, isUrdu && styles.rtl]}>{t.ageLabel}</UrduText>
          <View style={styles.selectorRow}>
            {AGE_OPTIONS.map(a => (
              <TouchableOpacity
                key={a.key}
              ...
              >
                <UrduText isUrdu={isUrdu} numberOfLines={0} style={[styles.selectorBtnText, selectedAge === a.key && styles.selectorBtnTextSelected]}>
                  {isUrdu ? a.ur : a.en}
                </UrduText>
              </TouchableOpacity>
            ))}
        ...
        {SYMPTOM_CATEGORIES.map(cat => (
          <View key={cat.key} style={styles.section}>
            <UrduText isUrdu={isUrdu} style={[styles.sectionTitle, isUrdu && styles.rtl]}>
        ...
        <View style={styles.summaryBar}>
          <UrduText isUrdu={isUrdu} style={[styles.summaryTitle, isUrdu && styles.rtl]}>
            {t.selected}: <Text style={styles.summaryCount}>{selectedList.length}</Text>
          </UrduText>
          <UrduText isUrdu={isUrdu} style={[styles.summaryList, isUrdu && styles.rtl]}>
