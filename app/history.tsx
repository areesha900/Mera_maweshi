...
const HISTORY = [
  { id: 1, disease_en: 'Lumpy Skin Disease', disease_ur: 'گانٹھ دار جلد کی بیماری', animal: 'Cattle', animal_ur: 'گائے', age: '4 yrs', date_en: 'June 18, 2026', date_ur: '۱۸ جون ۲۰۲۶', status: 'ongoing', icon: '🐄', color: '#ffebee' },
  { id: 2, disease_en: 'Foot and Mouth Disease', disease_ur: 'منہ کھر', animal: 'Buffalo', animal_ur: 'بھینس', age: '6 yrs', date_en: 'May 2, 2026', date_ur: '۲ مئی ۲۰۲۶', status: 'treated', icon: '🐃', color: '#e8f5e9' },
  { id: 3, disease_en: 'Drenching Pneumonia', disease_ur: 'نمونیا', animal: 'Goat', animal_ur: 'بکری', age: '2 yrs', date_en: 'Mar 14, 2026', date_ur: '۱۴ مارچ ۲۰۲۶', status: 'treated', icon: '🐐', color: '#f3e5f5' },
  { id: 4, disease_en: 'Theileriosis', disease_ur: 'تھیلیریوسس', animal: 'Cattle', animal_ur: 'گائے', age: '3 yrs', date_en: 'Jan 5, 2026', date_ur: '۵ جنوری ۲۰۲۶', status: 'treated', icon: '🐄', color: '#fff3e0' },
];
          ...
          <View key={item.id} style={styles.item}>
            ...
            <View style={styles.info}>
              ...
              <Text style={[styles.animal, isUrdu && styles.rtl]}>
                {isUrdu ? item.animal_ur : item.animal} · {item.age}
              </Text>
